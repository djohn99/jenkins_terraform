...
function servPrep(){
    ...
    yum install build-essential libgd2-xpm-dev openssl libssl-dev xinetd apache2-utils unzip -y;
}

function prereq(){
    sudo yum install apache2 php5-mysql php5 libapache2-mod-php5 php5-mcrypt php5-cli php5-cgi php5-common php5-curl -y;
